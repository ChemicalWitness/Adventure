...
var _mainNav = require("./modules/main-nav");
var _video = require("./modules/video");
var _hero = require("./modules/hero");
var _upcomingToursSlider = require("./modules/upcoming-tours-slider");
var _instructorsSlider = require("./modules/instructors-slider");
var _reviewsSlider = require("./modules/reviews-slider");
var _benefitsSlider = require("./modules/benefits-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _mainNav.checkWindow)();
    (0, _mainNav.initMenu)();
    (0, _hero.heroSlider)();
    (0, _audio.initAudio)();
    (0, _upcomingToursSlider.upcomingToursSlider)();
    (0, _instructorsSlider.instructorsSlider)();
    (0, _reviewsSlider.reviewsSlider)();
    (0, _benefitsSlider.benefitsSlider)();
...
},{"./modules/audio":2,"./modules/benefits-slider":3,"./modules/form-validate/form":5,"./modules/gallery-slider":11,"./modules/hero":12,"./modules/instructors-slider":13,"./modules/main-nav":14,"./modules/map":15,"./modules/modals/init-modals":16,"./modules/reviews-slider":18,"./modules/upcoming-tours-slider":19,"./modules/video":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";
...
var pagination = document.querySelector('.hero__pagination-wrapper');
var audio = document.querySelector('.hero__slide-audio');
var initAudio = function initAudio() {
  return pagination.addEventListener('click', function () {
    slides.forEach(function (slide) {
      if (slide.querySelector('.hero__slide-audio') && slide.classList.contains('swiper-slide-active')) {
...
exports.benefitsSlider = void 0;
var Swiper = window.Swiper;
var slider = document.querySelector('.benefits__slider');
var breakpointDesktop = window.innerWidth;
var swiper;
...
exports.benefitsSlider = benefitsSlider;
...
var gallerySlider = function gallerySlider() {
  return slider && new Swiper('.gallery__slider', {
    navigation: {
...
exports.instructorsSlider = void 0;
var Swiper = window.Swiper;
var slider = document.querySelector('.learning__instructors-slider');
var instructorsSlider = function instructorsSlider() {
  return slider && new Swiper('.learning__instructors-slider', {
    navigation: {
...
exports.instructorsSlider = instructorsSlider;
...
exports.toggleHandlerNav = exports.initMenu = exports.checkWindow = void 0;
...
var toggleHandlerNav = function toggleHandlerNav() {
...
exports.toggleHandlerNav = toggleHandlerNav;
...
},{"../../utils/focus-lock":21,"../../utils/scroll-lock":24}],18:[function(require,module,exports){
"use strict";
...
var reviewsSlider = function reviewsSlider() {
  return slider && new Swiper('.reviews__slider', {
    navigation: {
...
exports.upcomingToursSlider = void 0;
var Swiper = window.Swiper;
var slider = document.querySelector('.upcoming-tours__slider');
var upcomingToursSlider = function upcomingToursSlider() {
  return slider && new Swiper('.upcoming-tours__slider', {
    navigation: {
...
exports.upcomingToursSlider = upcomingToursSlider;
...
var playerIframe = document.querySelector(".hero__slide-video");
function findVideo() {
  var tag = document.createElement("script");
  tag.src = "https://www.youtube.com/iframe_api";
  var firstScriptTag = document.getElementsByTagName("script")[0];
  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);
  var link = document.querySelector(".hero__slide-video-btn");
    ...
    link.addEventListener("click", function (evt) {
      ...
      new YT.Player(playerIframe, {
        ...
        events: {
          ...
          'onStateChange': _hero.onPlayerStateChange
        }
      });
      evt.stopPropagation();
    });
...
},{"./hero":12}],21:[function(require,module,exports){
"use strict";
