...
},{"./modules/benefits-slider":2,"./modules/form-validate/form":4,"./modules/hero":10,"./modules/instructors-slider":11,"./modules/main-nav":12,"./modules/modals/init-modals":13,"./modules/reviews-slider":15,"./modules/upcoming-tours-slider":16,"./modules/video":17,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
var benefitsSlider = function benefitsSlider() {
  return window.matchMedia('(min-width: 1200px').matches && slider && new Swiper('.benefits__slider', {
    navigation: {
